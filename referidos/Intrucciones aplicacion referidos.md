...
### Tabla : `🧑‍💼Contacts ** YA ESTÁ CREADA, NO SE HA DE CREAR**
En esta tabla tendremos tanto a referidos como a referidores (clientes actuales).En los campos tipo enlace de airtable tendremos si es un referido o referidor: campo "referidos" y campo "referido por"


* **Nombre** (Single line text)
* **Email** (Email) - *Campo único*
* **Teléfono** (Phone)
* **recordid**(Formula/ID) - se genera el recordid de airtable
...
### Tabla b: `Recompensas` (Histórico) **SE HA DE CREAR**
* **Lead** (Link to Leads)
